    ...
    <>
      <section style={{paddingTop: "20em"}}>
        ...
        <div className="tab-content" id="myTabContent">
          ...
          <div>Current categories: {selectedArticle.map(doc => doc.categories.map(category =>
          ...
          <div className="form-article__box-btn">
            ...
            <div className="output">
              ...
              {fileSuccess &&
              <div>Image Uploaded successfully: <img style={{width: "25%", height: "auto"}} src={url} alt=""/></div>}
            </div>
            <button
